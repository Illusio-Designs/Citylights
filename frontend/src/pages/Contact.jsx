            ...
            <div className="contact-info-item phone-numbers-section">
              ...
              <div className="contact-info-content">
                ...
                <div className="contact-phone-cards">
                  <a href="tel:+918128888899" className="phone-card">
                    ...
                    <div className="phone-card-content">
                      ...
                      <span className="phone-card-number">+91 81288 88899</span>
                    </div>
                  </a>
                  <a href="tel:+919879873757" className="phone-card">
                    ...
                    <div className="phone-card-content">
                      <span className="phone-card-label">Customer Support</span>
                      <span className="phone-card-number">+91 98798 73757</span>
                    </div>
                  </a>
                </div>
              </div>

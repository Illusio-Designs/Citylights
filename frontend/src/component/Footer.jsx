          ...
          <div className="footer-info">
            ...
            <div className="footer-info-contact">
              <div className="Contact">
                ...
                <div className="contact-cards-grid">
                  <a href="tel:+918128888899" className="contact-card">
                    <div className="contact-card-icon sales">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                        <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5zM2 5h12v9a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V5z"/>
                      </svg>
                    </div>
                    <div className="contact-card-content">
                      <span className="contact-card-label">Sales Inquiry</span>
                      <span className="contact-card-number">+91 81288 88899</span>
                    </div>
                  </a>
                  <a href="tel:+919879873757" className="contact-card">
                    ...
                    <div className="contact-card-content">
                      ...
                      <span className="contact-card-number">+91 98798 73757</span>
                    </div>
                  </a>
                </div>
              </div>
            ...
            <div className="Follow">
              ...
              <div className="follow-icons">
                <a href="https://www.facebook.com/share/1KQ2cWoLW6/" target="_blank" rel="noopener noreferrer">
                  <svg
                ...
                <a href="https://www.instagram.com/vivera_lighting?igsh=MWRzMTVqdDhxdjRraw%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
